...
!(function (t, e) {
  ...
  function arcToSegment(t, e, n, i, s, a, o, r, h) {
    if (t !== r || e !== h) {
      ...
      var S = (a === o ? -1 : 1) * U(C),
        ...
        T = (-m - x) / i,
        N = k * k + D * D,
        R = (D < 0 ? -1 : 1) * Math.acos(k / U(N)),
        L =
          (k * T - D * H < 0 ? -1 : 1) *
          Math.acos((k * H + D * T) / U(N * (H * H + T * T)));
      isNaN(L) && (L = u),
        !o && 0 < L ? (L -= g) : o && L < 0 && (L += g),
        (R %= g),
        (L %= g);
      ...
      for (B = 0; B < X; B++)
        (_ = W((s = R + B * I))),
          ...
          (k = W((s += I))),
          (D = F(s)),
          O.push(_ - G * m, m + G * _, k + G * D, D - G * k, k, D);
      for (B = 0; B < O.length; B += 2)
        (_ = O[B]),
          (m = O[B + 1]),
          (O[B] = _ * q + m * V + E),
          (O[B + 1] = _ * z + m * Y + M);
      return (O[B - 2] = r), (O[B - 1] = h), O;
    }
  }
    ...
    for (e = 0; e < y; e++)
      if (
        ...
        (c = v - r[r.length - 4]),
          ...
          (e += 2);
      else if ("H" === a) sd(v, b, (v = i), b), (e += 1);
      else if ("V" === a) sd(v, b, v, (b = i + (o ? b - v : 0))), (e += 1);
      else if ("L" === a || "Z" === a)
  ...
  function bezierToPoints(t, e, n, i, s, a, o, r, h, l, c) {
    ...
    return (
      l || ((l = [t, e, o, r]), (c = 2)),
      l.splice(c || l.length - 2, 0, A, C),
      h * (S * S + w * w) < (x + E) * (x + E) &&
        ((d = l.length),
        bezierToPoints(t, e, u, g, v, b, A, C, h, l, c),
        bezierToPoints(A, C, y, P, _, m, o, r, h, l, c + 2 + (l.length - d))),
      l
    );
  }
  function pointsToSegment(t, e) {
    ...
    var i,
      ...
      C = y - v,
      S = P - b,
      w = Math.abs(t[m] - v) < 0.001 && Math.abs(t[m + 1] - b) < 0.001;
    for (
      w &&
        (t.push(y, P),
        (y = v),
      ...
      (i = v),
        ...
        (v === y && b === P) ||
          ...
          (S = P - b),
          (c =
            (((h = U(o * o + r * r)) + (l = U(C * C + S * S))) * e * 0.25) /
            U(Math.pow(C / l + o / h, 2) + Math.pow(S / l + r / h, 2))),
          (g =
            v -
            ((d = v - (v - i) * (h ? c / h : 0)) +
              ((((u = v + (y - v) * (l ? c / l : 0)) - d) *
    ...
    return (
      ...
      2 === A.length
        ? A.push(v, b, v, b, v, b)
        : w && (A.splice(0, 6), (A.length = A.length - 6)),
      A
    );
  }
    ...
    if ((c.length || c.push(J(t, 1), J(t, 2), J(t, 3)), (n = h ? m : u), h))
      ...
      if (((a = o = 0), y))
        for (
          ...
          4 < (p.getComputedStyle(s)[w] + "").length &&
  ...
  function jb(t, e, n) {
    return cb(t) && At.test(t)
      ? pt.querySelector(t)
      : Array.isArray(t)
      ? bt(
          vt(
            [{ x: ut.getProperty(e, "x"), y: ut.getProperty(e, "y") }].concat(
              t
            ),
            n
          )
        )
      : cb(t) || (t && "path" === (t.tagName + "").toLowerCase())
      ? t
      : 0;
  }
  function ob(t, e) {
    ...
    (gt = window),
      ...
      mt
        ? ((function _initCopyToClipboard() {
            ((Pt = db("textarea")).style.display = "none"), _t.appendChild(Pt);
          })(),
  ...
  var ut,
    ...
    Pt,
    At = /(^[#\.][a-z]|[a-y][a-z])/i,
    Ct = { matrix: { a: 1, b: 0, c: 0, d: 1, e: 0, f: 0 } },
    St =
